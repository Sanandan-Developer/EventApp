      ...
      <FormContainer>
        <div className="form-container">
          <form>
            ...
            <Link to = "/Login/AdminPanel" className="panel">Admin</Link>
            <Link to = "/Login/User" className="panel">User</Link>
            <div className="bottom-form">
              ...
              <br />
              <br />
              <span style={{ color: "#999" }}>New to Our Site?</span>&nbsp;
...
const FormContainer = styled.div`
    ...
    form div label {
        ...
        color: #8a8a8a;
        font-size: 1rem;
        transition: trasnform 150ms ease-out, font-size 150ms ease-out;
    }
    form div {
        position: relative;
    }
